...
| --- | --- | --- | --- |
| learning.guides | Présent : huit guides locaux, dont Personnage, Conflit, Synopsis et Plan détaillé, facultatifs avec relecture et reprise. Catalogue limité. | `learning_content.py`, `content/sessions/`, `app.py:show_learning` | `tests/test_learning_content.py`, `tests/test_character_guide.py`, `tests/test_conflict_guide.py`, `tests/test_synopsis_guide.py`, `tests/test_outline_guide.py`, `tests/test_ui_smoke.py` |
...
Le contrôle complet du 9 septembre 2026 rapporte 132 tests réussis. Ce résultat protège les chemins testés sans constituer une preuve de couverture exhaustive.
