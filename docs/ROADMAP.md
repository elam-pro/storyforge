...
- Ensembles 9 et 18 : réalisés dans un même espace **Univers > Cartes**. Plusieurs cartes et échelles peuvent coexister ; chaque canevas accepte un fond issu d’Images, des lieux existants et des repères de terrain libres. Couleurs, légende, calques par type, déplacement, panoramique, zoom, export/réimport et export final PNG/PDF/CSV conservent les liens sans créer une seconde bibliothèque de lieux.
