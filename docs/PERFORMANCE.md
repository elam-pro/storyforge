...
47,71 ms ; réduction demandée au décodeur, 12,67 ms. Cache chaud inférieur à
...
Lieux 57,26 ms (max 59,49), Personnages 52,42 ms (max 54,59), Vue d’ensemble
25,05 ms (max 29,19). Les canevas lourds utilisent les mêmes 200 personnages,
600 événements répartis sur trois timelines et 600 repères géographiques :
Chronologie 20,42 ms (max 28,08), carte de 200 nœuds et 199 relations 52,53 ms
(max 55,74), carte géographique 8,00 ms (max 8,22). Ces mesures couvrent la
